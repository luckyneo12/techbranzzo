...
const hero_content = {
    sub_title: "Wellcome to Tech Branzzo",
    title: <>
    <span><span className='child'>Innovative</span></span>{" "}
    <span><span className='child'>Tech Solutions</span></span>{" "}
    <span><span className='child'>for the Future</span></span>
    </>,
