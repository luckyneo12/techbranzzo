                     ...
                     <div className="tp-hero-five-section-wrap">
                        <div className="tp-hero-five-section-box z-index">
                           <h3 className="tp-hero-title-5 hero-text-anim-2">
                              <i><i className="child-2">Delivering The <br /></i></i>
                              <i>
                                 <i className="child-2">
                                    Most <span className="child-1 p-relative">Innovative
                                       <LineShapTwo />
                                    </span>
                                    <br />
                                 </i>
                              </i>
                              <i><i className="child-2"><span className="child-2">Tech Solutions</span> With <br /></i></i>
                              <i><i className="child-2">Excellence</i></i>
                           </h3>
                           <p className="wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".5s">
                              Empowering businesses with cutting-edge technology to streamline your processes and ensure security.
                           </p>
                        </div>
                        <div className="tp-hero-five-btn-box d-flex align-items-center wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".7s">
                           <Link className="tp-btn-blue-lg purple-bg circle-effect mr-15 mb-20" href="/">Start Your Journey</Link>
                           <Link className="tp-btn-grey mb-20" href="/services">Explore Our Services</Link>
                        </div>
                     </div>
                  </div>
               </div>
