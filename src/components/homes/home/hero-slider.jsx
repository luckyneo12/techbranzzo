    ...
    hero_title: (
        <>
          <span className="tp_title">
            <span className="child">Build Bold.</span>
          </span>
          <br />
          <span>
            <span className="child">Scale Smart.</span>
          </span>
        </>
      ),
      sub_title: <>Tech Branzzo turns your digital ideas into powerful solutions — fast, flexible, and future-ready.</>,
