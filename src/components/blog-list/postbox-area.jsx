...
const blog_page_data = [
  {
    ...
    des: (
      <>
        Explore how early exposure to tech tools can boost cognitive development. A guide designed for parents, educators, and budding developers.
      </>
    ),
  },
  {
    ...
    des: (
      <>
        A behind-the-scenes look at creating interactive environments for children, blending UI/UX design with educational psychology.
      </>
    ),
  },
  {
    ...
    date: "April 12, 2023",
    video: [],
    title: "Leveraging Content Marketing for Lead Generation",
    des: (
      <>
        From publishing content to extracting real-time analytics—learn how Tech Branzzo empowers digital campaigns through smart content strategies.
      </>
    ),
  },
];
