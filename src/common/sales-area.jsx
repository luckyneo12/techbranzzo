...
const sales_content = {
  ...
  dub_title: <>Smarter Sales Insights, Instantly</>,
  description: <>Monitor transactions, simplify payment flows, and gain deep financial insights—all in one intuitive dashboard.</>,
