...
// about content
const about_content = {
    title: "Reliable Tech Partner for 100+ Clients",
    sub_title: "We Offer Real-Time Business Solutions", 
    des: <>At Tech Branzzo, we deliver tailored digital solutions that drive growth and efficiency. <br />
    From startups to enterprises, we help you thrive in a connected world.</>,

    about_list: [
        <>Custom web and mobile app development.</>,
        <>CRM, BPM and SaaS platform solutions.</>,
        <>Smart data-driven insights and automation.</>,
        <>Social Media Handling, Digital Marketing,Content Writing & Creation.</>,
    ],
    btn_text: "About Us",
}
